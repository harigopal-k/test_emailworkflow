		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Email Task Using Start UI",
									"targetURL": "#atsemailstartuiemailstartuiworkflow-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"atsemailstartuiemailstartuiworkflow-display": {
								"semanticObject": "atsemailstartuiemailstartuiworkflow",
								"action": "display",
								"description": "Email Task Using Start UI",
								"title": "Email Task Using Start UI",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ats.emailstartui.emailstartuiworkflow",
									"url": sap.ui.require.toUrl("ats/emailstartui/emailstartuiworkflow")
								}
							}
						}
					}
